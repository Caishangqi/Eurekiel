...
static constexpr char LINE_FEED       = 0x0a; // all line endings are normalized to LF
static constexpr char LF              = LINE_FEED;
static constexpr char CARRIAGE_RETURN = 0x0d; // CR gets filtered out
...
namespace tinyxml2
{
    ...
    {
        static auto defTrue  = "true";
        static auto defFalse = "false";
    ...
    */
    ...
    char* XMLDocument::Identify(char* p, XMLNode** node, bool first)
    {
        ...
        TIXMLASSERT(p);
        char* const start     = p;
        const int   startLine = _parseCurLineNum;
    ...
    XMLError XMLDocument::LoadFile(FILE* fp)
    {
        ...
        constexpr size_t maxSizeT = static_cast<size_t>(-1);
