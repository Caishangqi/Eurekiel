...
namespace enigma::graphic
{
    ...
    void ShadowTargetManager::CreateShadowTargets()
    {
    ...
    std::shared_ptr<D12Texture> ShadowTargetManager::GetShadowTarget(int index) const
    {
    ...
    uint32_t ShadowTargetManager::GetShadowTexIndex(int index) const
    {
        if (index < 0 || index >= m_activeShadowTexCount)
        {
            LogError(LogRenderer, "Invalid index: {}, valid range: [0, {})",
    ...
    void ShadowTargetManager::OnResize(int baseWidth, int baseHeight)
    {
