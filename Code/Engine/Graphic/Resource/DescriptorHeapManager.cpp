 ...
 */
uint32_t DescriptorHeapManager::GetCbvSrvUavCount() const
{
    std::lock_guard<std::mutex> lock(m_mutex);
 ...
 */
uint32_t DescriptorHeapManager::GetCbvSrvUavCapacity() const
{
 ...
 * @brief 获取RTV堆已使用数量
 */
uint32_t DescriptorHeapManager::GetRtvCount() const
{
    std::lock_guard<std::mutex> lock(m_mutex);
 ...
 * @brief 获取RTV堆总容量
 */
uint32_t DescriptorHeapManager::GetRtvCapacity() const
{
 ...
 * @brief 获取DSV堆已使用数量
 */
uint32_t DescriptorHeapManager::GetDsvCount() const
{
    std::lock_guard<std::mutex> lock(m_mutex);
 ...
 * @brief 获取DSV堆总容量
 */
uint32_t DescriptorHeapManager::GetDsvCapacity() const
{
 ...
 */
uint32_t DescriptorHeapManager::GetSamplerCount() const
{
    std::lock_guard<std::mutex> lock(m_mutex);
 ...
 * @brief 获取Sampler堆总容量
 */
uint32_t DescriptorHeapManager::GetSamplerCapacity() const
{
