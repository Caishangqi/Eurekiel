...
namespace enigma::registry::block { class Block; }
namespace enigma::renderer::model { struct RenderMesh; }
namespace enigma::voxel::world { class World; }
...
namespace std
{
    ...
    {
        size_t operator()(const enigma::voxel::block::BlockState& state) const
        {
