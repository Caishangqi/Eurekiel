...
// ITimeProvider.hpp
//
// Pure virtual interface for time access in VoxelLight module
...
namespace enigma::voxel
{
    ...
    public:
        ...
        //-------------------------------------------------------------------------------------------
        // Sun angle calculation - Reference: Iris CelestialUniforms.java:24-32
        ...
        //-------------------------------------------------------------------------------------------
        // Cloud color calculation - Reference: Minecraft ClientLevel.java:673-703
